...
select
    nombre,
    precio,
    round(precio * 1.09707, 2) as dolares
...
select
    nombre,
    precio as Euros,
    round(precio * 1.09707, 2) as Dolares_Norteamericanos_USD
from tienda.producto;
...
SELECT *
FROM tienda.producto
    inner join tienda.fabricante on codigo_fabricante;
